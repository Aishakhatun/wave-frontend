...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden bg-pearl" ref={scrollRef}>
      {/* ─── Hero Section ─── */}
      <section className="relative min-h-[65vh] flex items-center pt-24 pb-10 px-6 lg:px-0">
          ...
          >
            <div className="relative group">
              ...
              <div className="relative z-10 bg-white p-3 md:p-4 rounded-[40px] md:rounded-[55px] shadow-[0_40px_100px_rgba(26,143,181,0.08)] border border-ocean/5 overflow-hidden">
                <div className="overflow-hidden rounded-[30px] md:rounded-[45px] aspect-square md:h-[420px] max-w-[420px] mx-auto">
                  <motion.img
                    initial={{ scale: 1.1 }}
                    animate={{ scale: 1 }}
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative order-1 lg:order-2 flex justify-center">
              <div className="relative bg-white p-3 rounded-[32px] shadow-[0_30px_60px_rgba(26,143,181,0.1)] border border-ocean/5 overflow-hidden max-w-xs w-full">
                <img
